Function ConvertLANDeskTaskXMLTo-Object 
{
	<#	
		.SYNOPSIS
			The ConvertLANDeskTaskXMLTo-Object function creates a PowerShell object from an exported LANDesk XML report.
		...
		.EXAMPLE
			ConvertLANDeskTaskXMLTo-Object -Path C:\Scripts\GFIRemaining.xml
