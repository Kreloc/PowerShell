Function Get-LANDeskInfoXMLReport 
{
	<#	
		.SYNOPSIS
			The Get-LANDeskInfoXMLReport function creates a PowerShell object from an exported LANDesk XML report.
		...
		.EXAMPLE
			Get-LANDeskInfoXMLReport -Path C:\Scripts\GFIRemaining.xml
