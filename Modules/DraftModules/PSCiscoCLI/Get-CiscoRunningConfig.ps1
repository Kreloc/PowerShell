Function Get-CiscoRunningConfig 
{
	<#	
		...
		.EXAMPLE
			Get-CiscoRunningConfig -SwitchName 192.168.1.1
			
			Returns the output of the show running-config on the Cisco switch with an address of 192.168.1.1 and saves it to a text file in the
