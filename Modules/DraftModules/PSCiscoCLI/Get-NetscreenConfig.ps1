Function Get-NetscreenConfig 
{
	<#	
		...
		.EXAMPLE
			Get-NetscreenConfig -SwitchName "192.168.2.1" -Verbose
			
			Connects to the netscreen at 192.168.2.1, prompts for credentials, and displays the output of get config on the netscreen. This output
