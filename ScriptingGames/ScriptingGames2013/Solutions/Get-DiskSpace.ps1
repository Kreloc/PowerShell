Function Get-DiskSpace 
{
	<#	
		.SYNOPSIS
			A brief description of the Get-DiskSpace function.
		
		.DESCRIPTION
			A detailed description of the Get-DiskSpace function.
		
		.PARAMETER ComputerName
			A description of the ComputerName parameter.
		
		.EXAMPLE
			Get-DiskSpace <ComputerName>
			
			Explanation of this example
			
		.EXAMPLE
			Get-Content computers.txt | Get-DiskSpace
